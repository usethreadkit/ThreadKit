 ...
 */
export const it: LocaleMetadata = {
  code: 'it',
  rtl: false,
  translations: {
  // Common actions
  ...
  toggleCollapseFocusedComment: 'Attiva/disattiva compressione',
  ...
  siteNotConfiguredMessage:
    'Questa chiave API non è associata a un sito configurato. Visita usethreadkit.com/sites per completare la configurazione.',
