...
async function debug() {
  // Start server
  const server = spawn('npx', ['http-server', 'test-pages', '-p', '8766', '--cors'], {
    stdio: 'pipe',
  });
  ...
  console.log('Loading http://localhost:8766/hyvor-talk.html...\n');
  await page.goto('http://localhost:8766/hyvor-talk.html', { waitUntil: 'networkidle', timeout: 60000 });
